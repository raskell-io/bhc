...
fn register_standard_module_exports(
    ...
    let exports: &[&str] = match module_name {
        ...
        "Data.ByteString.Builder" => &[
            ...
            "byteString", "shortByteString", "lazyByteString",
            ...
            "char7", "char8", "string7", "string8",
            "word16BE", "word32BE", "word64BE",
            "int16BE", "int32BE", "int64BE",
            "word16LE", "word32LE", "word64LE",
            "int16LE", "int32LE", "int64LE",
            "word16Host", "word32Host", "word64Host",
            "int16Host", "int32Host", "int64Host",
            "wordHex", "word8Hex", "word16Hex", "word32Hex", "word64Hex",
            "word8HexFixed", "word16HexFixed", "word32HexFixed", "word64HexFixed",
            "floatBE", "doubleBE", "floatLE", "doubleLE",
            "floatHost", "doubleHost",
        ],
        // === Data.Text family ===
        "Data.Text" => &[
            "Text",
        ...
        | "Control.Monad.Trans.State" | "Control.Monad.Trans.State.Strict" | "Control.Monad.Trans.State.Lazy" => &[
            "StateT",
            "State",
            "runStateT",
            "runState",
        ...
        | "Control.Monad.Trans.Writer" | "Control.Monad.Trans.Writer.Strict" | "Control.Monad.Trans.Writer.Lazy" => &[
            "WriterT",
            "Writer",
            "runWriterT",
            "runWriter",
        ...
        "Control.Monad.Trans" | "Control.Monad.Trans.Class" => &[
            "lift",
            "MonadTrans",
        ],
        ...
        "Foreign.Marshal" | "Foreign.Marshal.Alloc" => &[
            "malloc",
            "free",
            "alloca",
            "allocaBytes",
