...
impl LowerContext {
    ...
    fn define_builtins(&mut self) {
        ...
        let builtin_funcs = [
            ...
            // Container PrimOps: Data.Text.Lazy (chunked lazy text)
            ...
            "Data.Text.Lazy.take",
            "Data.Text.Lazy.drop",
            // Container PrimOps: Data.ByteString.Lazy (chunked lazy bytestring)
            ...
            // Container PrimOps: Data.ByteString.Lazy.Char8
