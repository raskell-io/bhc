...
#[test]
fn test_tier3_user_monad_native() {
    run_native_test("tier3_io/user_monad", Profile::Default);
}
...
#[test]
fn test_tier3_derive_read() {
    run_native_test("tier3_io/derive_read", Profile::Default);
}
...
#[test]
fn test_tier3_builder_basic_native() {
    run_native_test("tier3_io/builder_basic", Profile::Default);
}
...
#[test]
fn test_tier3_foreign_import_native() {
